...
function Connections({ pushActivity, flash, emitHotelEvent }) {
  ...
  const [backendHealth, setBackendHealth] = useState({ state:"checking", configured:false, database:false, signature:false, worker:false, dispatcher:false, orchestrator:false, mode:"checking" });
  ...
  const checkBackendHealth = async (notify = false) => {
    ...
    try {
      ...
      const next = {
        ...
        orchestrator: Boolean(data.dependencies?.scheduler_orchestration_authentication),
      ...
      setBackendHealth({ state:"unavailable", configured:false, database:false, signature:false, worker:false, dispatcher:false, orchestrator:false, mode:"unavailable" });
  ...
  return <>
    ...
    <section className={"panel backend-readiness-card " + backendHealth.state}>
      ...
      <div className="backend-readiness-grid">
        ...
        <div><RefreshCw size={17}/><span>Scheduler orchestration</span><b>{backendHealth.orchestrator ? "Authenticated" : "Not configured"}</b></div>
