...
function Connections({ pushActivity, flash, emitHotelEvent }) {
  ...
  const [backendHealth, setBackendHealth] = useState({ state:"checking", configured:false, database:false, signature:false, worker:false, dispatcher:false, orchestratorAuth:false, orchestratorEnabled:false, tenantBootstrapEnabled:false, teamInvitesEnabled:false, mode:"checking" });
  ...
  const checkBackendHealth = async (notify = false) => {
    ...
    try {
      ...
      const next = {
        ...
        teamInvitesEnabled: Boolean(data.dependencies?.team_invitations_enabled),
      ...
      setBackendHealth({ state:"unavailable", configured:false, database:false, signature:false, worker:false, dispatcher:false, orchestratorAuth:false, orchestratorEnabled:false, tenantBootstrapEnabled:false, teamInvitesEnabled:false, mode:"unavailable" });
  ...
  return <>
    ...
    <section className={"panel backend-readiness-card " + backendHealth.state}>
      ...
      <div className="backend-readiness-grid">
        ...
        <div><UserCog size={17}/><span>Team invitations</span><b>{backendHealth.teamInvitesEnabled ? "Enabled" : "Staged · disabled"}</b></div>
